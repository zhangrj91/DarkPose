...
# mpii_keypoints_id['r_ankle'] = 0
# mpii_keypoints_id['r_knee']= 1
# mpii_keypoints_id['r_hip'] = 2
# mpii_keypoints_id['l_hip'] = 3
# mpii_keypoints_id['l_knee'] = 4
# mpii_keypoints_id['l_ankle'] = 5
# mpii_keypoints_id['pelvis'] = 6
# mpii_keypoints_id['throax'] = 7
# mpii_keypoints_id['upper_neck'] = 8
# mpii_keypoints_id['head_top'] = 9
# mpii_keypoints_id['r_wrist'] = 10
# mpii_keypoints_id['l_elbow'] = 11
# mpii_keypoints_id['r_shoulder'] = 12
# mpii_keypoints_id['l_shoulder'] = 13
# mpii_keypoints_id['r_elbow'] = 14
# mpii_keypoints_id['l_wrist'] = 15
...
def parts_mode(dataset_name, parts_num):
    ...
    parts = {}
    assert parts_num == 1 or parts_num == 3 or parts_num == 8 or parts_num == 5 or parts_num == 16 or parts_num == 17
    ...
    if parts_num == 3:
        ...
        parts['upper_limb_part'] = [k('l_shoulder'), k('r_shoulder'), k('l_elbow'), k('r_elbow'), k('l_wrist'),
                                    k('r_wrist')]
    ...
    if parts_num == 5:
        ...
        if dataset_name == 'mpii':
            parts['head_shoulder_part'] = [k('head_top'), k('upper_neck'), k('throax'), k('l_shoulder'),
                                           k('r_shoulder')]
            parts['hips_part'] = [k('pelvis'), k('l_hip'), k('r_hip')]

        if dataset_name == 'coco':
            parts['head_shoulder_part'] = [k('nose'), k('l_eye'), k('r_eye'), k('l_ear'), k('r_ear'), k('l_shoulder'),
                                           k('r_shoulder')]
